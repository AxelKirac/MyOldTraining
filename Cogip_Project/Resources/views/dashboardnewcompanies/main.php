<main class="right">
    <img class="dashboard__illustration" src="assets/img/illu.png" alt="Illustration">
            ...
            <p class="dashboard__position">dashboard/new-companies</p>
            ...
            <div class="taskscreate">
                ...
                <form class="newtasksforms" action="" method="" id="registering">
                    ...
                    <input type="number" class="newtasks" name="lastname" id="lastname" placeholder="TVA">
                    <input type="text" class="newtasks" name="mail" id="mail" placeholder="Country">
